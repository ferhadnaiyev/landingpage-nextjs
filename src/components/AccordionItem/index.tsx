...
function AccordionItem({ queue, accordionHeader, accordionBody }) {
    ...
    return (
        <li>
            ...
            box-shadow flex flex-col  list-none rounded-[45px] px-[60px] py-[40] border border-black font-medium`}>
                <div className='flex justify-between items-center'>
                    ...
                    <button onClick={handleClick} className='flex justify-center items-center rounded-full h-[58px] w-[58px] border border-black  bg-grey'>
                        {
                            isOpen ? (
